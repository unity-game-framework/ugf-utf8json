    ...
    internal partial class EnumTemplate : EnumTemplateBase
    {
        ...
        public virtual string TransformText()
        {
            ...
            foreach (var info in enumSerializationInfos)
            {
                ...
                this.Write(">\r\n    {\r\n        public void Serialize(ref global::Utf8Json.JsonWriter writer, ");
                ...
                this.Write(" Deserialize(ref global::Utf8Json.JsonReader reader, global::Utf8Json.IJsonFormatterResolver" +
                           " formatterResolver)\r\n        {\r\n            return (");
